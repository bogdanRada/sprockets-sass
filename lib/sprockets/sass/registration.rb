...
module Sprockets
  module Sass
    ...
    class Registration
      ...
      AVAILABLE_VERSIONS = [4, 3, 2].freeze

      DEFAULT_ACTION = { min_comparison: '>=', min: 2, max_comparison: '<', max: 3, action: :register_sprockets_legacy }.freeze
    ...
    private
      ...
      def register_sprockets_v4
        ...
        _register_v4_preprocessors(
          Sprockets::Sass::Utils.get_class_by_version('SassTemplate') => ['text/sass', 'text/css'],
          Sprockets::Sass::Utils.get_class_by_version('ScssTemplate') => ['text/scss', 'text/css']
        )
      end
